...
public class CorsConfig implements WebMvcConfigurer {
    ...
    public void addCorsMappings(CorsRegistry registry) {
        ...
        registry.addMapping("/v1/jobs/**")
                .allowedOrigins("http://sj-bff-service/","http://k8s-sjns-sjbffser-2442aa6474-7bbbdd5862cd73a5.elb.ap-southeast-1.amazonaws.com/","http://shiok-jobs-client-bucket.s3-website-ap-southeast-1.amazonaws.com/") // You can specify specific origins instead of "*"
