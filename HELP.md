...
* The original package name 'com.mtech.sj-ms-job' is invalid and this project uses 'com.mtech.sjmsjob' instead.
...
* [Accessing data with Postgres](https://spring.io/guides/gs/accessing-data-mysql/)
